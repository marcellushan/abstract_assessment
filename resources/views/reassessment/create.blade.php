@extends('layouts.dashboard') @section('content')
    ...
    <div class="well">
    <h1 align="center">2016 - 2017 Assessment Results require reassessment</h1>
    ...
    <div class="well">
    <h1 align="center">New 2017-2018 Assessment</h1>
        <form action="{{URL::to('/')}}/reassessment" method="post" id="assessment">
            {{ csrf_field() }}
